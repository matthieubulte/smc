...
\begin{lemma}
  Let $(\mu_n)_{n \in \mathbb{N}}$ be a sequence of random probability measures in $\mathcal{P}(X)$ and $\mu \in \mathcal{P}(X)$ such that $\underset{n \rightarrow \infty}{\text{lim}} d(\mu_n, \mu) = 0$, then the sequence $(\mu_n)_{n \in \mathbb{N}}$ converges to $\delta_\mu$ almost surely.
\end{lemma}
\begin{proof}
  ...
  \begin{equation*}
    \P\left(\underset{n \rightarrow \infty}{\text{lim}}\mu_n = \mu\right) = 1.
  \end{equation*}
  ...
  \begin{equation*}
    \P\left(\underset{n \rightarrow \infty}{\text{lim}} \mu_n \neq \mu\right) = \P\left(\underset{n \rightarrow \infty}{\text{lim}}\ \underset{|f|_\infty\leq 1}{\text{sup}}\ |\mu_n(f) - \mu(f)|^2 > 0\right) = 0,
  \end{equation*}
